...
public class RecordContentProvider extends ContentProvider implements RecordTableColumns{
	...
	private static final String uri =
		    "content://es.uja.git.sm.examples.contentproviders/registros";
	...
	static {
	    ...
	    uriMatcher.addURI("es.uja.git.sm.examples.contentproviders", "registros", RECORD);
	    uriMatcher.addURI("es.uja.git.sm.examples.contentproviders", "registros/#", RECORD_ID);
	}
